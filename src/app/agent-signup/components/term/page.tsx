    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <main className="flex-1 relative">
        <div className="px-4 pb-28 pt-3">
          {/* Keep the column narrow for readability */}
          <article className="max-w-[640px] mx-auto">
            ...
            <p className="text-[13px] leading-[20px]">
              ...
              being credited.
              <br /> - Mistaken or fraudulent recharges are non-refundable
              unless otherwise approved by Little Wheel.
            </p>
            <h2 className="text-[14px] font-bold text-blue-600 font-inter mt-4">
            ...
            <p className="text-[13px] leading-[20px]">
              ...
              of the platform.
              <br /> - Immediately report any suspected data breach or
              suspicious activity.
            </p>
            <h2 className="text-[14px] font-bold text-blue-600 font-inter mt-4">
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-white px-4 pb-[calc(env(safe-area-inset-bottom,0px)+10px)] pt-2 border-t">
        <div className="max-w-[640px] mx-auto">
          <button
            onClick={agree}
            className="w-full h-11 rounded-xl bg-black text-white font-semibold hover:bg-black/90 transition"
          >
            Yes, I agree
          </button>
        </div>

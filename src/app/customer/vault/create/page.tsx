...
export default function CreateSavingsVaultPage() {
  ...
  const viewVault = () => {
    ...
    if (!customerId) {
      ...
      startTransition(() => router.replace("/customer/vault"));
      return;
    }
  ...
  return (
    <>
      {/* ✅ Global route spinner (same pattern as your BottomTabs) */}
        ...
        <div className="w-full max-w-sm bg-white min-h-screen md:min-h-0 md:rounded-3xl md:shadow-xl overflow-hidden">
          ...
          <div className="px-4 pt-4 pb-2 flex items-center justify-between">
            <button
              ...
              disabled={submitting}
              className="inline-flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900 disabled:opacity-60 disabled:cursor-not-allowed"
            >
